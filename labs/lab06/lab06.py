...
class BankAccount:
    ...
    def record_action(self):
        if self.transactions:
            balance_before=self.transactions[-1].after
        else:
            balance_before=0
        balance_after=self.balance
        action=Transaction(self.trans_id,balance_before,balance_after)
        self.trans_id+=1
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        exist_year=Mint.present_year-self.year
        return self.cents+exist_year-50 if exist_year>50 else self.cents
